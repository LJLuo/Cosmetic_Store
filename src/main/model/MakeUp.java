...
//A type of product, makeup, that will be sold in stores
public class MakeUp implements Product {
    private static String type = "makeup";
    ...
    // EFFECTS: create a new MakeUp Object, which implements the Product interface,
    // with name and brand.
    // Price, stock quantity, product ID, totalPurchasedTimes and rating should be
    // initially set to zero
    // list of ingredients should initially be set to empty
    // product ID should be unique to every product
    public MakeUp(String productName, String brand) {
        this.price = 0;
    ...
    // EFFECTS: return this makeup object as JSON object
    @Override
